...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.registerArmor(ModItems.AWAKENED_TURTLE_HELMET, ArmorMaterials.TURTLE_SCUTE.assetId(), ItemModelGenerator.HELMET_TRIM_ID_PREFIX, false);
        itemModelGenerator.registerArmor(ModItems.AWAKENED_NAUTILUS_CHESTPLATE, ModArmorMaterials.NAUTILUS_SHELL_KEY, ItemModelGenerator.CHESTPLATE_TRIM_ID_PREFIX, false);
        itemModelGenerator.registerArmor(ModItems.AWAKENED_FROG_LEGGINGS, ModArmorMaterials.FROG_HIDE_KEY, ItemModelGenerator.LEGGINGS_TRIM_ID_PREFIX, false);
        itemModelGenerator.registerArmor(ModItems.AWAKENED_FROG_BOOTS, ModArmorMaterials.FROG_HIDE_KEY, ItemModelGenerator.BOOTS_TRIM_ID_PREFIX, false);
